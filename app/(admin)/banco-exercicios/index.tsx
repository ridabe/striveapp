...
export default function BancoExerciciosScreen() {
  ...
  const load = useCallback(async () => {
    ...
    let q = supabase.from('exercises')
      .select('id, name, muscle_group, load_type, count_type, default_sets, default_reps, is_global')
  ...
  return (
    <SafeAreaView style={s.safe} edges={['top']}>
      ...
      <View style={s.statsRow}>
        <Text style={s.statsText}>{exercises.length} exercícios</Text>
